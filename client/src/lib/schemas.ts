...
const ItemSchema = z.object({
  ...
  product_line_code: fieldValidators.string,
  product_line_name: fieldValidators.string,
...
const PaymentFormSchema = z.object({
  ...
  employee_code: fieldValidators.stringToNumber,
  employee_name: fieldValidators.stringOptional,
  pay_to: fieldValidators.string,
  purchase_order: fieldValidators.stringToNumber,
  ap_invoice: fieldValidators.stringToNumber,
